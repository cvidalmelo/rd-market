...
CREATE TABLE "new_Compra" (
    ...
    CONSTRAINT "Compra_usuarioId_fkey" FOREIGN KEY ("usuarioId") REFERENCES "user" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "Compra_productoId_fkey" FOREIGN KEY ("productoId") REFERENCES "Producto" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
INSERT INTO "new_Compra" ("cantidad", "fecha", "id", "productoId", "usuarioId") SELECT "cantidad", "fecha", "id", "productoId", "usuarioId" FROM "Compra";
DROP TABLE "Compra";
